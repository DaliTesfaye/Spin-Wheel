          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              ...
              <button 
                ...
                className="bg-linear-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
                ♻️ Reload Products from Code
              </button>
            </div>
